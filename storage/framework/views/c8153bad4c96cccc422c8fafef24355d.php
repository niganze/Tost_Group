        ...
        <div class="box_">
                    ...
                    <form id="filterform"  role="form"  method="get" action="<?php echo e(adminUrl(array('controller'=>'session','action'=>'browseclasses','id'=>$sessionId))); ?>?type=<?php echo e(@$_GET['type']); ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="visually-hidden" for="group"><?php echo e(__lang('class-group')); ?></label>
...
<?php /**PATH C:\Users\ALAIN\Desktop\traineasy\traineasy\traineasy\resources\views/admin/session/browseclasses.blade.php ENDPATH**/ ?>