...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input type="checkbox" name="remember" class="form-check-input" tabindex="3" id="remember-me"  <?php echo e(old('remember') ? 'checked' : ''); ?> >
                                <label class="form-check-label" for="remember-me"><?php echo e(__lang('remember-me')); ?></label>
                            </div>
                        </div>
                    ...
                    <?php if(setting('social_enable_facebook')==1 || setting('social_enable_google')==1): ?>
                        ...
                        <div class="row sm-gutters">
                            <?php if(setting('social_enable_facebook')==1): ?>
                                <div class="col-6">
                                    <a href="<?php echo e(route('social.login',['network'=>'facebook'])); ?>" class="btn w-100 btn-social btn-facebook">
                            ...
                            <?php if(setting('social_enable_google')==1): ?>
                                <div class="col-6">
                                    <a href="<?php echo e(route('social.login',['network'=>'google'])); ?>" class="btn w-100 btn-social btn-google">
                ...
                <div class="col-md-6 text-center pt-3 pe-5 ps-5">
                    ...
                    <br>
                    <a href="<?php echo e(route('register')); ?>" class="btn btn-primary w-100 btn-lg"><?php echo e(__lang('register')); ?></a>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ALAIN\Desktop\traineasy\traineasy\traineasy\resources\views/auth/login.blade.php ENDPATH**/ ?>