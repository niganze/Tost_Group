            ...
            <?php if($homeworkPresent): ?>
                ...
                <div class="card-body">
                    ...
                    <div class="card-footer">
                        <a href="<?php echo e(route('student.assignment.index')); ?>" class="btn btn-success   float-end"><i class="fa fa-edit"></i> <?php echo e(__lang('view-homework')); ?></a>
                    </div>
                </div>
                                ...
                                <li class="d-flex media">
                                    ...
                                    <a href="<?php echo e($url); ?>">
                                        ...
                                        <?php if(!empty($row->picture)): ?>
                                            <img class="me-3 rounded" src="<?php echo e(resizeImage($row->picture,671,480,basePath())); ?>" alt="product" width="50">

                                        <?php else: ?>
                                            <img class="me-3 rounded" src="<?php echo e(asset('img/course.png')); ?>" alt="product" width="50">

                                        <?php endif; ?>
                                    </a>
                                    <div class="flex-grow-1">
                                        <div class="d-flex-right"><a class="btn btn-primary btn-sm float-end" href="<?php echo e($url); ?>"><i class="fa fa-play-circle"></i> <?php echo e(__lang('view')); ?></a></div>
                                        <div class="d-flex-title media-title"><a href="<?php echo e($url); ?>"><?php echo e(limitLength($row->name,100)); ?></a>
                ...
                <div class="card card-success">
                    ...
                    <div class="card-body">
                          <ul class="nav nav-pills" id="myTab3" role="tablist">
                                                <li class="nav-item">
                                                  <a class="nav-link active" id="home-tab3" data-bs-toggle="tab" href="#home3" role="tab" aria-controls="home" aria-selected="true"><?php echo e(__lang('student-forum')); ?></a>
                                                </li>
                                                <li class="nav-item">
                                                  <a class="nav-link" id="profile-tab3" data-bs-toggle="tab" href="#profile3" role="tab" aria-controls="profile" aria-selected="false"><?php echo e(__lang('instructor-chats')); ?></a>
                                                </li>
                                              </ul>
                                                ...
                                                <div class="tab-pane fade show active" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                                                    ...
                                                    <ul class="list-unstyled list-unstyled-border">
                                                        <?php $__currentLoopData = $forumTopics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <li class="d-flex media">
                                                                <?php if($user): ?>
                                                                    <img data-bs-toggle="tooltip" data-bs-placement="top" data-original-title="<?php echo e($user->name); ?>" class="mr-3 rounded-circle" width="50" src="<?php echo e(profilePictureUrl($user->picture)); ?>" alt="avatar">
                                                                <?php endif; ?>
                                                                <div class="flex-grow-1 px-3">
                                                                    <a  class="badge rounded-pill text-bg-success mb-1 float-end" href="<?php echo e(route('student.forum.topic',['id'=>$row->forum_topic_id])); ?>"><?php echo e(__lang('view')); ?></a>

                                                                    <h6 class="d-flex-title media-title"><a href="<?php echo e(route('student.forum.topic',['id'=>$row->id])); ?>"><?php echo e($row->title); ?></a></h6>
                                                    ...
                                                    <ul class="list-unstyled list-unstyled-border">
                                                        <?php $__currentLoopData = $discussions['paginator']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <li class="d-flex media">
                                                                ...
                                                                <div class="flex-grow-1">
                                                                    <a  class="badge rounded-pill text-bg-success mb-1 float-end" href="<?php echo e(route('student.student.viewdiscussion',['id'=>$row->id])); ?>"><?php echo e(__lang('view')); ?></a>

                                                                    <h6 class="d-flex-title media-title"><a href="<?php echo e(route('student.student.viewdiscussion',['id'=>$row->id])); ?>"><?php echo e($row->subject); ?></a></h6>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col text-center">
                            ...
                            <div class="mt-2 fw-bold"><?php echo e($row->certificate_name); ?></div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                        ...
                        <div class="summary-item">
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                ...
                                <li class="d-flex media">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="d-flex-right media-right float-end"><?php echo e(round($testResult->score)); ?>%</div>
                                        <div class="d-flex-title media-title"><a href="<?php echo e(route('student.test.taketest',['id'=>$testResult->test_id])); ?>"><?php echo e($testResult->test->name); ?></a></div>
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ALAIN\Desktop\traineasy\traineasy\traineasy\resources\views/student/index/index.blade.php ENDPATH**/ ?>