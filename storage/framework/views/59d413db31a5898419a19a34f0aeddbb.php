            ...
            <div class="card">
                ...
                <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border">
                        ...
                        <li class="d-flex">
                            <img class="me-3 rounded-circle" width="50" src="<?php echo e(profilePictureUrl($row->picture)); ?>" alt="avatar">
                            <div class="flex-grow-1">
                                <div class="float-end text-primary"><?php echo e(\Illuminate\Support\Carbon::parse($row->created_at)->diffForHumans()); ?></div>
                                <div class="d-flex-title"><?php echo e($row->name); ?> <?php echo e($row->last_name); ?></div>
                ...
                <div class="card-body">
                    <div class="row pb-2">
                        ...
                        <div class="col-4 col-sm-3 col-lg-2 mb-4 mb-md-0">
                            <div class="avatar-item mb-0  viewbutton <?php if($user->student): ?> int_curpoin <?php endif; ?>"  <?php if($user->student): ?>   data-id="<?php echo e($user->student->id); ?>" data-bs-toggle="modal" data-bs-target="#simpleModal" title="<?php echo app('translator')->get('default.view'); ?>"   <?php endif; ?> >
                                <img  alt="image" src="<?php echo e(profilePictureUrl($user->picture)); ?>" class="img-fluid" data-bs-toggle="tooltip" title="<?php echo e($user->name); ?> <?php echo e($user->last_name); ?>">
                                <div class="avatar-badge" title="<?php echo e(__lang($user->role->name)); ?>" data-bs-toggle="tooltip">
                ...
                <div class="card-body">
                    ...
                    <?php $__currentLoopData = $invoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invoice): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <li class="d-flex media">
                            <img class="me-3 rounded-circle" width="50" src="<?php echo e(profilePictureUrl($invoice->user->picture)); ?>" alt="avatar">
                            <div class="flex-grow-1">
                                <?php if($invoice->paid==1): ?>
                                <div class="badge rounded-pill text-bg-success mb-1 float-end"><?php echo e(__lang('paid')); ?></div>
                                <?php else: ?>
                                <div class="badge rounded-pill text-bg-danger mb-1 float-end"><?php echo e(__lang('unpaid')); ?></div>
                                <?php endif; ?>

                                <h6 class="d-flex-title media-title"><a class=" viewbutton "  <?php if($invoice->user->student): ?>   data-id="<?php echo e($invoice->user->student->id); ?>" data-bs-toggle="modal" data-bs-target="#simpleModal" title="<?php echo app('translator')->get('default.view'); ?>"   <?php endif; ?> href="#"><?php echo e($invoice->user->name); ?> <?php echo e($invoice->user->last_name); ?></a></h6>
                            ...
                            <ul class="list-unstyled list-unstyled-border">
                                ...
                                <li class="d-flex">
                                    <a <?php if($course->type != 'c'): ?>  href="<?php echo e(route('admin.student.editsession',['id'=>$row->id])); ?>"  <?php else: ?>  href="<?php echo e(route('admin.session.editcourse',['id'=>$row->id])); ?>"  <?php endif; ?> >
                                        <img class="me-3 rounded" width="50" <?php if(!empty($course->picture) && file_exists($course->picture)): ?> src="<?php echo e(asset($course->picture)); ?>"  <?php else: ?> src="<?php echo e(asset('client/themes/admin/assets/img/products/product-2-50.png')); ?>" <?php endif; ?> alt="product">
                                    </a>
                                    <div class="flex-grow-1 media">
                                        <div class="d-flex-right media-right float-end"><?php echo e(price($course->fee)); ?></div>
                                        <div class="d-flex-title media-title"><a  <?php if($course->type != 'c'): ?>  href="<?php echo e(route('admin.student.editsession',['id'=>$row->id])); ?>"  <?php else: ?>  href="<?php echo e(route('admin.session.editcourse',['id'=>$row->id])); ?>"  <?php endif; ?> ><?php echo e($course->name); ?></a></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ALAIN\Desktop\traineasy\traineasy\traineasy\resources\views/admin/home/index.blade.php ENDPATH**/ ?>