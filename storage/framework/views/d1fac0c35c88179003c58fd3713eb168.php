                    ...
                    <div id="step-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <div >
                                        <label for="enable_discussion" class="control-label"><?php echo e(__lang('enforce-class-order')); ?></label>
                                    </div>
                                    <div >
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ALAIN\Desktop\traineasy\traineasy\traineasy\resources\views/admin/student/addsession.blade.php ENDPATH**/ ?>