...
<section class="bg-gray-100 py-12" id="verify-certificate">
    <div class="container mx-auto px-4">
        <div class="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-8">
            ...
            <form action="<?php echo e(route('verify')); ?>" method="POST" class="certificate-verification-form">
    <?php echo csrf_field(); ?>
    <div class="mb-4">
...
<?php echo $__env->make(TLAYOUT, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ALAIN\Desktop\traineasy\traineasy\traineasy\public\templates/edugrids/views/site/home/index.blade.php ENDPATH**/ ?>