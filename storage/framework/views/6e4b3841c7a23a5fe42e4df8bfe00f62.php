...
<p>
    <?php echo e(__lang('drag-and-drop-rows')); ?>
        ...
        <a class="btn btn-primary float-end" href="#"  data-bs-toggle="modal" data-bs-target="#addClassModal"><i class="fa fa-plus"></i> <?php echo e(__lang('Add Class')); ?></a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab3" data-bs-toggle="tab" href="#home3" role="tab" aria-controls="home" aria-selected="true"><?php echo e(__lang('new-class')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab3" data-bs-toggle="tab" href="#profile3" role="tab" aria-controls="profile" aria-selected="false"><?php echo e(__lang('existing-class')); ?></a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent2">
                        <div class="tab-pane fade show active" id="home3" role="tabpanel" aria-labelledby="home-tab3">
                            ...
                            <form method="post" action="<?php echo e(adminUrl(array('controller'=>'lesson','action'=>'add')).'?sessionId='.$session->id.'&back=true'); ?>">
                                ...
                                <div id="test_id_box" class="mb-3 online">
                                ...
                                <div class="form-footer">
                                    <button type="submit" class="btn btn-primary w-100"><?php echo e(__lang('save-changes')); ?></button>
                                </div>
                            </form>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ALAIN\Desktop\traineasy\traineasy\traineasy\resources\views/admin/session/sessionclasses.blade.php ENDPATH**/ ?>