            ...
            <form method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <?php $__currentLoopData = $fields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $field): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($field->type=='text'): ?>
                            <div class="mb-3<?php echo e($errors->has('field_'.$field->id) ? ' has-error' : ''); ?>  col-6">
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input type="checkbox" name="agree" class="form-check-input" id="agree" required <?php echo e(old('agree')? 'checked':''); ?> >
                        <label class="form-check-label" for="agree"><?php echo __lang('i-accept-terms',['link'=>route('terms')]); ?></label>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ALAIN\Desktop\traineasy\traineasy\traineasy\resources\views/auth/register.blade.php ENDPATH**/ ?>