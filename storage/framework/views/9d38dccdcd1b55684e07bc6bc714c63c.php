...
<?php $__env->startSection('search-form'); ?>
    <form class="d-flex align-items-center me-auto" method="get" action="<?php echo e(route('admin.student.sessions')); ?>">
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="section">
        ...
        <button class="btn btn-success"  data-bs-toggle="collapse" href="#collapseFilter" role="button" aria-expanded="false" aria-controls="collapseFilter"><i class="fa fa-filter"></i> <?php echo e(__lang('filter')); ?></button>
        <br> <br>
            ...
            <div class="card card-body">
                <form id="filterform"   role="form"  method="get" action="<?php echo e(route('admin.student.sessions')); ?>">
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="visually-hidden" for="filter"><?php echo e(__lang('filter')); ?></label>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="visually-hidden" for="group"><?php echo e(__lang('category')); ?></label>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="visually-hidden" for="group"><?php echo e(__lang('sort')); ?></label>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="visually-hidden" for="group"><?php echo e(__lang('type')); ?></label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="visually-hidden" for="group"><?php echo e(__lang('payment-required')); ?></label>
...
[$__name, $__params] = $__split('admin.course.pinned-course',['course'=>$course]);

$__html = app('livewire')->mount($__name, $__params, 'lw-2263070436-0', $__slots ?? [], get_defined_vars());
...
?>
                ...
                <div class="article-details">
                    ...
                    <div class="article-footer">
                        <div class="row">
                            <div class="col-md-6">
                                <button data-bs-toggle="modal" data-bs-target="#infoModal-<?php echo e($row->id); ?>" class="btn w-100 btn-primary"><i class="fa fa-info-circle"></i> <?php echo e(__lang('info')); ?></button>
                            </div>
                            <div class="col-md-6">
                                <div class="btn-group dropup hundred-percent">
                                    <button class="btn w-100 btn-dark dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group dropup hundred-percent">
                                    <button class="btn w-100 btn-success dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3-<?php echo e($row->id); ?>" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab3-<?php echo e($row->id); ?>" data-bs-toggle="tab" href="#home3-<?php echo e($row->id); ?>" role="tab" aria-controls="home" aria-selected="true"><?php echo e(__lang('general')); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab3-<?php echo e($row->id); ?>" data-bs-toggle="tab" href="#profile3-<?php echo e($row->id); ?>" role="tab" aria-controls="profile" aria-selected="false"><?php echo e(__lang('totals')); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab3-<?php echo e($row->id); ?>" data-bs-toggle="tab" href="#contact3-<?php echo e($row->id); ?>" role="tab" aria-controls="contact" aria-selected="false"><?php echo e(__lang('classes')); ?></a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab4-<?php echo e($row->id); ?>" data-bs-toggle="tab" href="#contact4-<?php echo e($row->id); ?>" role="tab" aria-controls="contact4" aria-selected="false"><?php echo e(__lang('instructors')); ?></a>
                                </li>
                            </ul>
                                  ...
                                  <table class="table table-stripped">
                                      ...
                                      <tbody>
                                        <?php $__currentLoopData = $course->admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td>
                                                    <figure class="avatar me-2 avatar-xl">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ALAIN\Desktop\traineasy\traineasy\traineasy\resources\views/admin/student/sessions.blade.php ENDPATH**/ ?>