                ...
                <?php if(config('app.credits')==true): ?>
                    <?php if(saas()): ?>
                        <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
                            <a target="_blank" href="https://traineasy.net/docs" class="btn btn-primary btn-lg w-100 btn-icon-split">
                                <i class="fa fa-question-circle"></i> <?php echo app('translator')->get('default.help'); ?>
                            </a>
                        </div>
                    <?php else: ?>
                <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
                    <a target="_blank" href="https://intermaticsng.com/docs/category/1" class="btn btn-primary btn-lg w-100 btn-icon-split">
                        <i class="fa fa-question-circle"></i> <?php echo app('translator')->get('default.help'); ?>
                    </a>
                </div>
                    <?php endif; ?>
...
<?php /**PATH C:\Users\ALAIN\Desktop\traineasy\traineasy\traineasy\resources\views/layouts/admin.blade.php ENDPATH**/ ?>