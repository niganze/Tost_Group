        ...
        <div class="container">
            <div class="row">
                                    ...
                                    <article class="article article-style-c">
                                        ...
                                        <div class="article-details">
                                                    ...
                                                    <div class="article-user col-md-6">
                                                        ...
                                                        <div class="article-user-details">
                                                            <div class="user-detail-name">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#adminModal-<?php echo e($admin->id); ?>"><?php echo e(limitLength(adminName($admin->id),20)); ?></a>
                                                            </div>
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="row">
                                                                        <div class="col-md-3">
                                                                            <figure class="avatar me-2 avatar-xl text-center">
                                            ...
                                            <div class="article-footer">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <a class="btn btn-primary w-100" href="<?php echo e(route('course',['course'=>$course->id,'slug'=>safeUrl($course->name)])); ?>"><i class="fa fa-info-circle"></i> <?php echo e(__lang('details')); ?></a>
                                                    </div>
                                                </div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-default" data-bs-toggle="card-collapse" data-open="true">
                        ...
                        <div class="card-body">
                            <form id="filterform" class="form" role="form"  method="get" action="<?php echo e(route('sessions')); ?>">
                                <div class="mb-3 input-group margin-none">
...
<div class="row">
        ...
        <?php  foreach($paginator as $row):  ?>
            ...
            <div class="panel panel-default paper-shadow" data-z="0.5">
                <div class="panel-body">
                    ...
                    <div class="media d-flex-clearfix-xs">
                        <div class="d-flex-left text-center">
                        ...
                        <div class="flex-grow-1">
                                ...
                                <?php  foreach($session->sessionInstructors as $instructor): ?>
                                    <div class="col-md-4">
                                        <div class="d-flex v-middle">
                                            ...
                                            <div class="flex-grow-1">
                                                <h4><a href="#"  data-bs-toggle="modal" data-bs-target="#instructorModal<?php echo e($instructor->session_instructor_id); ?>"><?php echo e($instructor->account->name); ?> <?php echo e($instructor->account->last_name); ?></a><br/></h4>
                            ...
                            <a href="<?php echo e($this->url('session-details',array('id'=>$row->session_id))); ?>" class="btn btn-primary float-end"><i class="fa fa-info-circle"></i> <?php echo e(__lang('details')); ?></a>
    ...
    <div class="col-md-3">
           ...
           <div class="panel panel-default" data-bs-toggle="panel-collapse" data-open="true">
...
<?php echo $__env->make('layouts.student', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ALAIN\Desktop\traineasy\traineasy\traineasy\resources\views/site/catalog/sessions.blade.php ENDPATH**/ ?>