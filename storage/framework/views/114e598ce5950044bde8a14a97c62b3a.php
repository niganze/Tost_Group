...
<div id="app">
    <div class="main-wrapper container">
        ...
        <nav class="navbar navbar-expand-lg main-navbar">
            <a href="<?php echo e(url('/')); ?>" class="navbar-brand sidebar-gone-hide px-2"><?php echo e(limitLength(setting('general_site_name'),17)); ?></a>
            <a href="#" class="nav-link sidebar-gone-show" data-bs-toggle="sidebar"><i class="fas fa-bars"></i></a>
            ...
            <form class="d-flex align-items-center ms-auto" action="<?php echo e(route('courses')); ?>">
                <ul class="navbar-nav">
            ...
            <ul class="navbar-nav navbar-right">
                ...
                <li class="dropdown"><a href="#" data-bs-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        ...
                        <?php else: ?>
                            <img alt="image" src="<?php echo e(asset('client/themes/admin/assets/img/avatar/avatar-1.png')); ?>" class="rounded-circle me-1">
                        <?php endif; ?>
            ...
            <div class="container">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" class="nav-link has-dropdown"><i class="fas fa-chalkboard-teacher"></i><span><?php echo e(setting('label_my_sessions',__lang('my-courses'))); ?></span></a>
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" class="nav-link has-dropdown"><i class="fas fa-download"></i><span><?php echo e(setting('label_downloads',__lang('resources'))); ?></span></a>
                        <ul class="dropdown-menu dropdown-border">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" class="nav-link has-dropdown"><i class="fas fa-edit"></i><span><?php echo e(setting('label_homework',__lang('homework'))); ?></span></a>
                        <ul class="dropdown-menu dropdown-border">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" class="nav-link has-dropdown"><i class="fas fa-comments"></i><span><?php echo e(setting('label_discussion',__lang('discuss'))); ?></span></a>
                        <ul class="dropdown-menu dropdown-border">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" data-bs-toggle="dropdown" class="nav-link has-dropdown"><i class="fas fa-check-circle"></i><span><?php echo e(setting('label_take_test',__lang('tests'))); ?></span></a>
                        <ul class="dropdown-menu dropdown-border">
...
<script src="<?php echo e(asset('client/themes/admin/assets/modules/popper.min.js')); ?>"></script>
...
<?php /**PATH C:\Users\ALAIN\Desktop\traineasy\traineasy\traineasy\resources\views/layouts/student.blade.php ENDPATH**/ ?>