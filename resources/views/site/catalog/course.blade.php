        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-8">
                    <ul class="nav nav-pills mb-2" id="myTab3" role="tablist">
                        ...
                        @if($course->has('certificates'))
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab4" data-bs-toggle="tab" href="#contact4" role="tab" aria-controls="certificate" aria-selected="false"><i class="fa fa-file-pdf"></i> {{  __lang('certificates')  }}</a>
                            </li>
                        @endif
                ...
                <div class="col-md-4">
                    ...
                    <a class="btn btn-primary w-100 btn-lg" href="{{  route('cart.add',['course'=>$course->id])  }}"><i class="fa fa-cart-plus"></i> {{  __lang('enroll')  }}</a>
