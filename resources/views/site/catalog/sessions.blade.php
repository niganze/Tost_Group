                                    ...
                                    <article class="article article-style-c">
                                        ...
                                        <div class="article-details">
                                                    ...
                                                    <div class="article-user col-md-6">
                                                        ...
                                                        <div class="article-user-details">
                                                            <div class="user-detail-name">
                                                                <a href="#" data-bs-toggle="modal" data-bs-target="#adminModal-{{ $admin->id }}">{{ limitLength(adminName($admin->id),20) }}</a>
                                                            </div>
                                            ...
                                            <div class="article-footer">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <a class="btn btn-primary w-100" href="{{ route('course',['course'=>$course->id,'slug'=>safeUrl($course->name)]) }}"><i class="fa fa-info-circle"></i> {{ __lang('details') }}</a>
                                                    </div>
                                                </div>
                ...
                <div class="panel-body">
                    ...
                    <div class="media d-flex-clearfix-xs">
                        ...
                        <div class="flex-grow-1">
                                ...
                                @php  foreach($session->sessionInstructors as $instructor): @endphp
                                    <div class="col-md-4">
                                        <div class="d-flex v-middle">
                                            ...
                                            <div class="flex-grow-1">
                                                <h4><a href="#"  data-bs-toggle="modal" data-bs-target="#instructorModal{{ $instructor->session_instructor_id }}">{{ $instructor->account->name }} {{ $instructor->account->last_name }}</a><br/></h4>
                                                {{  __lang('instructor')  }}
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <a href="{{  $this->url('session-details',array('id'=>$row->session_id)) }}" class="btn btn-primary float-end"><i class="fa fa-info-circle"></i> {{  __lang('details')  }}</a>
