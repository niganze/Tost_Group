    ...
    <div class="tabs tabs-full">
        ...
        <form method="post" action="{{ route('LaravelInstaller::environmentSaveWizard') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="mb-3 {{ $errors->has('app_log_level') ? ' has-error ' : '' }}">
            ...
            <div class="tab" id="tab2content">
                ...
                <div class="mb-3 {{ $errors->has('database_hostname') ? ' has-error ' : '' }}">
                ...
                <div class="mb-3 {{ $errors->has('database_port') ? ' has-error ' : '' }}">
                ...
                <div class="mb-3 {{ $errors->has('database_username') ? ' has-error ' : '' }}">
                ...
                <div class="mb-3 {{ $errors->has('database_password') ? ' has-error ' : '' }}">
            ...
            <div class="tab" id="tab3content">
                <div class="block">
                    ...
                    <div class="info">
                            ...
                            <label for="broadcast_driver">{{ trans('installer_messages.environment.wizard.form.app_tabs.broadcasting_label') }}
                                <sup>
                                    <a href="https://laravel.com/docs/5.4/broadcasting" target="_blank" title="{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}">
                                        ...
                                        <span class="visually-hidden">{{ trans('installer_messages.environment.wizard.form.app_tabs.more_info') }}</span>
                                    </a>
                                </sup>
                            </label>
                        ...
                        <div class="mb-3 {{ $errors->has('queue_driver') ? ' has-error ' : '' }}">
