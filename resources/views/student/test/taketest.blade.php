            ...
            <div class="card card-default" id="intro">
                ...
                <div class="card-body">
                   <p>{!! $testRow->description !!}   </p>
                    <button type="button" id="start" class="btn btn-primary btn-lg float-end">{{  __lang('Start Test')  }}</button>
                </div>
            </div>
@php  $count = 0;  @endphp
...
@php  $count++;  @endphp
                <div class="card card-default question" id="question{{  $count  }}">
                    ...
                    <div class="card-body">
                        ...
                        @php  else:  @endphp
                         <a onclick="if(confirm('{{ __lang('submit-test-msg') }}')){$('#testform').submit()};" class="btn btn-success btn-lg float-end" href="#testform">{{  __lang('finish')  }}</a>
                        @php  endif;  @endphp
                    </div>
                </div>
            @php  endforeach;  @endphp
