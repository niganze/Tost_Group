...
<p>
    ...
    <a class="btn btn-primary float-end" href="#"  data-bs-toggle="modal" data-bs-target="#addClassModal"><i class="fa fa-plus"></i> {{ __lang('Add Class') }}</a>
</p>
        ...
        <tr  id="row-{{ $sessionLesson->id }}" class="sort_row">
            ...
            <td>
                ...
                <div class="btn-group dropup">
                    ...
                    <ul class="dropdown-menu wide-btn float-end animation-slide" role="menu" style="text-align: left;">
                ...
                <div class="modal-body">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <ul class="nav nav-pills" id="myTab3" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="home-tab3" data-bs-toggle="tab" href="#home3" role="tab" aria-controls="home" aria-selected="true">{{ __lang('new-class') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab3" data-bs-toggle="tab" href="#profile3" role="tab" aria-controls="profile" aria-selected="false">{{ __lang('existing-class') }}</a>
                            </li>
                        </ul>
                                            ...
                                            <div class="card-body_">
                                                ...
                                                <form method="post" action="{{ adminUrl(array('controller'=>'lesson','action'=>'add')).'?sessionId='.$session->id.'&back=true' }}">
                                                    ...
                                                    <div class="form-footer">
                                                        <button type="submit" class="btn btn-primary float-end">{{__lang('save-changes')}}</button>
                                                    </div>
                                                </form>
