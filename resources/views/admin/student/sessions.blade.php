...
@section('search-form')
    <form class="d-flex align-items-center me-auto" method="get" action="{{ route('admin.student.sessions') }}">
            ...
            <div class="card card-body">
                <form id="filterform"   role="form"  method="get" action="{{ route('admin.student.sessions')  }}">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="visually-hidden" for="group">{{ __lang('category') }}</label>
                                {{ formElement($select) }}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="visually-hidden" for="group">{{ __lang('sort') }}</label>
                                {{ formElement($sortSelect) }}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="visually-hidden" for="group">{{ __lang('type') }}</label>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="mb-3">
                                <label class="visually-hidden" for="group">{{ __lang('payment-required') }}</label>
            ...
            <article class="article article-style-c">
                ...
                <div class="article-details">
                    ...
                    <div class="article-footer">
                        <div class="row">
                            <div class="col-md-6">
                                <button data-bs-toggle="modal" data-bs-target="#infoModal-{{ $row->id }}" class="btn w-100 btn-primary"><i class="fa fa-info-circle"></i> {{ __lang('info') }}</button>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <ul class="nav nav-pills" id="myTab3-{{ $row->id }}" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="home-tab3-{{ $row->id }}" data-bs-toggle="tab" href="#home3-{{ $row->id }}" role="tab" aria-controls="home" aria-selected="true">{{ __lang('general') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab3-{{ $row->id }}" data-bs-toggle="tab" href="#profile3-{{ $row->id }}" role="tab" aria-controls="profile" aria-selected="false">{{ __lang('totals') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab3-{{ $row->id }}" data-bs-toggle="tab" href="#contact3-{{ $row->id }}" role="tab" aria-controls="contact" aria-selected="false">{{ __lang('classes') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="contact-tab4-{{ $row->id }}" data-bs-toggle="tab" href="#contact4-{{ $row->id }}" role="tab" aria-controls="contact4" aria-selected="false">{{ __lang('instructors') }}</a>
                                </li>
                            </ul>
