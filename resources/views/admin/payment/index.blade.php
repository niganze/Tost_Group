        ...
        <div class="card" id="methods">
            ...
            <div class="box-body content"  id="to-payment-methods">
                <div class="row" style=" padding-bottom: 10px" >
                    ...
                    <div class="col-md-3">
                        <button class="sort btn btn-inverse btn-sm w-100" data-sort="name">
                            {{ __lang('sort-by-name') }}
                        </button>
                    </div>
                    <div class="col-md-4">
                ...
                <table class="table table-hover">
                    ...
                    @php foreach($paginator as $row):  @endphp
                        <tr>
                            ...
                            <td >
                                <a href="{{ adminUrl(array('controller'=>'payment','action'=>'edit','id'=>$row->payment_method_id)) }}" class="btn btn-xs btn-primary btn-equal" data-bs-toggle="tooltip" data-bs-placement="top" data-original-title="{{__lang('edit')}}"><i class="fa fa-edit"></i> {{ __lang('edit') }}</a>
