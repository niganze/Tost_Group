            ...
            <div  id="accordionExample">
                        ...
                        <div class="accordion-body">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">{{ $page['name'] }}
                                    ...
                                    <span onclick="$(this).parent().submit()"  class="int_curpoin badge text-bg-primary rounded-pill float-end">@lang('default.add')</span>
                                    </form>
                                </li>
                ...
                <div class="accordion">
                    <div class="accordion-header" id="headingFour">
                        <h4   data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                    ...
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                        <div class="accordion-body">
                            ...
                            <form method="post" id="customForm" class="menuform resetform" action="{{ route('admin.menus.save-header') }}">
                                ...
                                <button class="btn btn-primary float-end">@lang('default.add')</button>
