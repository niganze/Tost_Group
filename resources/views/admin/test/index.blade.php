...
@section('search-form')
    <form class="d-flex align-items-center me-auto" method="get" action="{{ adminUrl(array('controller'=>'test','action'=>'index')) }}">
    ...
    <div >
        <div class="card">
            <div class="card-header">
                ...
                <a class="btn btn-primary float-end" href="{{ adminUrl(array('controller'=>'test','action'=>'add')) }}"><i class="fa fa-plus"></i> {{ __lang('add-test') }}</a>
